// ==========================================================
// VISTEX — Icon set
// Inline SVG line icons, 24×24 grid, currentColor stroke.
// Usage: window.icon('name', size, extraClass)
// ==========================================================
(function () {
  'use strict';
  ...
  var ICONS = {
    ...
    thermometer: '<path d="M14 14.8V4a2 2 0 1 0-4 0v10.8a4.5 4.5 0 1 0 4 0Z"/><path d="M12 9v7"/>',
    package: '<path d="m12 2 9 5v10l-9 5-9-5V7l9-5Z"/><path d="m3 7 9 5 9-5M12 12v10"/>',
    scale: '<path d="M12 3v18M6 7h12M6 7 3 14h6L6 7ZM18 7l-3 7h6l-3-7ZM8 21h8"/>',
    ...
    truck: '<path d="M3 6h11v10H3zM14 9h4l3 3v4h-7z"/><circle cx="7" cy="18" r="2"/><circle cx="17.5" cy="18" r="2"/>'
  };
  ...
  // Fill any <span data-ico="name" data-size="18"> placeholder in static markup.
  window.hydrateIcons = function (root) {
    (root || document).querySelectorAll('[data-ico]:not([data-ico-done])').forEach(function (el) {
      el.setAttribute('data-ico-done', '');
      el.insertAdjacentHTML('afterbegin', window.icon(el.dataset.ico, parseInt(el.dataset.size || '18', 10)));
    });
  };
})();
